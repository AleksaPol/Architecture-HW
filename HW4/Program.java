 ...
 */
    public static void main(String[] args) {
        ...
        // можно посмотреть список клиентов (пока их тут мало, можно просто выводить всех):
        ...
        // теперь пусть попробует поехать снова (по логике программы его должны не пустить и перекинуть на покупку билета):
        busStation.goOnBus(cust);
